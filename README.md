...
| Path | Contents |
|------|----------|
| `capability/slmp_builtin_ethernet_profiles.json` | Per-profile capability definitions for nine profiles. These policies are scoped to CPU built-in Ethernet ports only and include frame/subcommand groups, feature states, point limits, write policy, and route selection. |
