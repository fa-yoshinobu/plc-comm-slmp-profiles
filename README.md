...
| `tables/slmp_profile_comparison.md` | Generated maintenance view that compares capability and device-range JSON values by profile. Do not edit this file manually. |
