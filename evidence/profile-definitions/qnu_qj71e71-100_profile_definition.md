# QnU via QJ71E71-100 / melsec:qnu:qj71e71-100 Profile Definition

This is a unit-profile definition backed by live Q26UDEHCPU + QJ71E71-100 evidence.
The profile keeps `melsec:qnu` as its base profile for device range and address-resolution behavior, but uses the Ethernet-unit communication shape measured through QJ71E71-100.
...
| Area | Base `melsec:qnu` | Unit result | Decision |
|------|-------------------|-------------|----------|
...
| Device ranges | QnU baseline | same family/range model | Inherit base range data |

## Item

| Item | Value |
|------|-------|
| profile | `melsec:qnu:qj71e71-100` |
| definition_type | `live` |
| base_profile | `melsec:qnu` |
| source_evidence | `evidence/unit-investigations/plans/results/qj71e71-100_q26udehcpu.json` |
| live_verified | `true` |
| verified_models | `Q26UDEHCPU via QJ71E71-100` |
| scope | `ethernet-unit` |
| frame | `4E` |
| compat | `Q/L` |
