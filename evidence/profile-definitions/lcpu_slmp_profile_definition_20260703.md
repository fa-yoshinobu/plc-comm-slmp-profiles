# LCPU / melsec:lcpu Profile Definition

| Item | Value |
|------|-------|
| profile | `melsec:lcpu` |
| definition_type | `live` |
| source_evidence | `evidence/lcpu_slmp_live_verify_20260703.md` |
| live_verified | `true` |
| verified_models | `L26CPU-BT(built-in Ethernet)` |
| frame | `3E` |
| compat | `Q/L` |
...
| random_read_word_ext | 96 |  | C054 | inferred |
| random_write_word_ext | 80 | 960 | C054 | inferred |
| random_write_bit_ext | 94 |  | C053 | inferred |
| monitor_register_word_ext | 96 |  | C054 | inferred |
