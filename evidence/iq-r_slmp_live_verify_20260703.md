# iQ-R / melsec:iq-r SLMP Live Verification
...
|---------|------------------|-------------|--------|---------------|
| Type name | supported / live | - | pass | `R120PCPU` |
...
| `U...\G...` module buffer | `ext_module_access` | `U2\G100` | pass | Random word write verified. Unit/address availability remains configuration-dependent |
| `U3E0\HG...` CPU buffer | `hg_cpu_buffer` | `U3E0\HG20` | pass | iQ-R-only route; random word write verified |
...
| Random word write | max 80, weighted max 960, over `C054` | limit | 80 pass; 81 returned `C054` |
